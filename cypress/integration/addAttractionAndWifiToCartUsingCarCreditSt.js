describe('Add Attraction And Wifi To Cart Using Card Credit (Staging)', function() {
  ...
  describe('Add Attraction And Wifi To Cart Using Card Credit Before Login (Staging)', function() {
    it('contains "Masuk"', () => {
        //cy.server();
