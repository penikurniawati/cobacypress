describe('Booking Event With Insurance Using Card Credit (Staging)', function() {
  ...
  describe('Booking Event With Insurance Using Card Credit Before Login (Staging)', function() {
    it('Visits Passpod', function() {
      cy.visit(Cypress.env('BASE_URL'));
