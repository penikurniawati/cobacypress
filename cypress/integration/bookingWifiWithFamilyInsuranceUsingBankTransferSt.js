describe('Booking Wifi Using Credit Card (Staging)', function() {
  it('Visits Passpod', function() {
    ...
    cy.get('div.package input:eq(1)').click()
    ...
    cy.get('div.input-group:contains("Status") select:eq(0)').select("Adik")

    //Informasi Wisatawan Tambahan
    cy.get('.col-12 > :nth-child(2) > :nth-child(1) > .input-group > .form-control').type("Nama")
    cy.get('.col-12 > :nth-child(2) > :nth-child(2) > .input-group > .form-control').type("Test")
    cy.get('.col-12 > :nth-child(3) > :nth-child(1) > .input-group > .form-control').type("AB112212")
    cy.get('.col-12 > :nth-child(3) > :nth-child(2) > .input-group > .form-control').select("Wanita")
    cy.get('.col-12 > :nth-child(4) > .col-sm-8 > :nth-child(1) > .row > :nth-child(1) > .input-group > .form-control').select("11")
    cy.get('.col-12 > :nth-child(4) > .col-sm-8 > :nth-child(1) > .row > .col-6 > .input-group > .form-control').select("Feb")
    cy.get('.col-12 > :nth-child(4) > .col-sm-8 > :nth-child(1) > .row > :nth-child(3) > .input-group > .form-control').select("1997")

    cy.get('.add-qty').click()
    cy.get(':nth-child(2) > :nth-child(2) > :nth-child(1) > .input-group > .form-control').type("Bela")
    cy.get('.panel-body > :nth-child(1) > :nth-child(2) > :nth-child(2) > :nth-child(2) > .input-group > .form-control').type("Test")
    cy.get('.panel-body > :nth-child(1) > :nth-child(2) > :nth-child(3) > :nth-child(1) > .input-group > .form-control').type("AA12121")
    cy.get('.panel-body > :nth-child(1) > :nth-child(2) > :nth-child(4) > .col-sm-8 > :nth-child(1) > .row > :nth-child(1) > .input-group > .form-control').select("12")
    cy.get('.panel-body > :nth-child(1) > :nth-child(2) > :nth-child(4) > .col-sm-8 > :nth-child(1) > .row > .col-6 > .input-group > .form-control').select("Jun")
    cy.get('.panel-body > :nth-child(1) > :nth-child(2) > :nth-child(4) > .col-sm-8 > :nth-child(1) > .row > :nth-child(3) > .input-group > .form-control').select("2010")
    cy.get('.panel-body > :nth-child(1) > :nth-child(2) > :nth-child(4) > .col-sm-4 > .input-group > .form-control').select("Anak")
