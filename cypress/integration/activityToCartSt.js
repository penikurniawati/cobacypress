describe('Activity to cart before login', function() {
    it('contains "Masuk"', () => {
        ...
        cy.get('div.slick-slide div.dest-title:eq(3)').click().log('Click 2')
        ...
        // cy.get('#dropdown0 :nth-child(2) > .form-group > .form-control').select('19:15:00')
      ...
      cy.wait(1000)
      cy.get(':nth-child(5) > .input-group > .form-control').type('87654321900')
